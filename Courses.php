...
<div class="container courseBG">
	<img src="img/courseBanner.jpg" class="courseBannerImg">
</div>
<!-- End CourseBanner -->
<!-- Start All Courses  -->
				...
				<a href="#" class="btn" style="text-align: left;padding: 0px;margin: 0px;">
					<div class="card">
						...
						<div class="card-footer">
							...
							<a href="#" class="btn btn-sub-card  font-weight-bolder float-right">Enroll</a>
						</div>
					</div>
				</a>
				<a href="#" class="btn" style="text-align: left;padding: 0px;margin: 0px;">
			...
			<div class="card-deck mt-4">
				...
				<a href="#" class="btn" style="text-align: left;padding: 0px;margin: 0px;">
					<div class="card">
						...
						<img src="img/Python.jpg" class="card-img-top" alt="Guitar">
						<div class="card-body">
